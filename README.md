...
**Important** if you use http request using `Get` or `Delete` method you must be use `Send` with nil value and `Send` must be added before `Set`, please check example usage about this package is working.
